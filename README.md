...
The user has to select option from the user interface shown.
    ...
    1. The first Page is the Main Menu :
                  1. Sign Up
                  2. Sign In
                  3. Exit                
                  
    2. After sign Up , Chose sign In Option . It will take you to the Locker Page.

    3. The Locker consists the details of the user interface with following options.

            a. List the files to the existing directory list.

            b. Add,Delete or Search a user specified from the existing directory list.

            c. Show files in Ascending Order.
